...
from psql_api.sensors import get_sensors, get_sensor_units, get_sensor_parameter
...
@app.get("/api/v1/sensor_parameter/{user_sensor}")
def get__units(user_sensor: int):
    return get_sensor_parameter(user_sensor)